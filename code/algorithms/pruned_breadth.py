    ...
    def run(self):
        ...
        while self.proteins:
            ...
            if len(protein.direction_list) > 8 and protein.getscore() < 3:
                continue
            if len(protein.direction_list) > 12 and protein.getscore() < 4:
                continue
            if len(protein.direction_list) > 16 and protein.getscore() < 5:
                continue
            if len(protein.direction_list) > 20 and protein.getscore() < 6:
